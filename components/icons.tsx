...
export const GoogleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" {...props}>
    ...
    <path fill="#4CAF50" d="m24 44c5.166 0 9.86-1.977 13.409-5.192l-6.19-5.238A11.91 11.91 0 0 1 24 36c-5.218 0-9.619-3.317-11.283-7.946l-6.522 5.025C9.505 39.556 16.227 44 24 44z" />
    <path fill="#1976D2" d="M43.611 20.083H42V20H24v8h11.303c-.792 2.237-2.231 4.166-4.087 5.571l6.19 5.238C42.012 35.842 44 30.228 44 24c0-1.341-.138-2.65-.389-3.917z" />
  </svg>
);
...
export const WhatsappIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path fillRule="evenodd" d="M18.403 5.633A8.919 8.919 0 0 0 12.053 3c-4.948 0-8.976 4.027-8.976 8.977 0 1.582.413 3.126 1.198 4.488L3 21.116l4.759-1.249a8.981 8.981 0 0 0 4.29 1.093h.004c4.947 0 8.975-4.027 8.975-8.976a8.926 8.926 0 0 0-2.625-6.35m-6.35 13.812h-.004a7.446 7.446 0 0 1-3.774-1.042l-.272-.162-2.824.741.753-2.753-.177-.282a7.472 7.472 0 0 1-1.141-3.971c0-4.102 3.337-7.44 7.44-7.44a7.425 7.425 0 0 1 5.262 2.183 7.425 7.425 0 0 1 2.183 5.262c0 4.103-3.337 7.44-7.44 7.44m4.34-5.613c-.235-.119-1.392-.689-1.61-.769-.218-.08-.375-.119-.531.119-.156.239-.609.769-.747.926-.138.156-.277.177-.512.058s-1.011-.375-1.927-1.187c-.714-.637-1.198-1.422-1.34-1.667-.142-.245-.015-.375.104-.494.108-.108.235-.277.353-.415.118-.138.156-.239.234-.396.078-.157.039-.296-.02-.415-.059-.119-.531-1.274-.728-1.744s-.385-.396-.531-.406h-.452c-.156 0-.415.06-.623.308-.208.245-.792.77-.792 1.879s.81 2.176.928 2.333c.118.156 1.593 2.44 3.864 3.396.533.225.954.36 1.289.46.494.148.94.129 1.289.078.385-.059 1.187-.485 1.355-.954.168-.469.168-.867.118-.954s-.157-.157-.353-.277" clipRule="evenodd" />
  </svg>
);
...
export const GavelIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 6.75L12 9V5.25l2.25-2.25m0 0l6.25 6.25L12 15.75l-2.25 2.25-6.25-6.25L12 3l2.25 3.75z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M5.25 14.25l-1.5 1.5 6.25 6.25 1.5-1.5m-7.75-7.75l6.25-6.25" />
